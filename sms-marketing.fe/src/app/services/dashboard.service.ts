...
export class DashBoardService {
    ...
    getStatisticsUserCreditsTheoThangByUser(userId: string, tuThang: Date, denThang: Date) {
        const params: any = {
            userId,
            tuThang: Utils.formatDateCallApi(moment(tuThang).startOf('month').toDate()),
            denThang: Utils.formatDateCallApi(moment(denThang).endOf('month').toDate())
        };
