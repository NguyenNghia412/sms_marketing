...
import { MobilePreview } from '../gui-tin-nhan/mobile-preview/mobile-preview';
import { ChipModule } from 'primeng/chip';
import { RadioButtonModule } from 'primeng/radiobutton';
import { FormControl, FormGroup, FormsModule, Validators } from '@angular/forms';
import { Import } from '../gui-tin-nhan/import/import';
import { CreateQuick } from '../gui-tin-nhan/create-quick/create-quick';
import { ISaveConfigChienDich, IVerifySendSms } from '@/models/gui-tin-nhan.models';
import { DialogPreview } from '../gui-tin-nhan/dialog-preview/dialog-preview';

@Component({
    selector: 'app-gui-email',
    imports: [SharedImports, Breadcrumb, ChipModule, RadioButtonModule, FormsModule],
    templateUrl: './gui-email.html',
    styleUrl: './gui-email.scss'
})
export class GuiEmail extends BaseComponent {
    ...
    items: MenuItem[] = [{ label: 'Danh sách chiến dịch', routerLink: '/channel/email' }, { label: 'Gửi tin nhắn email' }];
