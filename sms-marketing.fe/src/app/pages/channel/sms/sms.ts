...
export class Sms {
    ...
    columns: IColumn[] = [
        { header: 'Name', field: 'name', headerContainerStyle: 'min-width: 12rem' },
        { header: 'Country', field: 'country.name', headerContainerStyle: 'min-width: 12rem' },
        { header: 'Agent', field: 'representative.name', headerContainerStyle: 'min-width: 14rem' },
        { header: 'Date', field: 'date', headerContainerStyle: 'min-width: 10rem', cellViewType: CellViewTypes.DATE },
        { header: 'Balance', field: 'balance', headerContainerStyle: 'min-width: 12rem', cellViewType: CellViewTypes.CURRENCY },
        { header: 'Status', field: '', headerContainerStyle: 'min-width: 12rem' },
        { header: 'Activity', field: '', headerContainerStyle: 'min-width: 12rem' },
        { header: 'Verified', field: '', headerContainerStyle: 'min-width: 8rem' }
    ];
