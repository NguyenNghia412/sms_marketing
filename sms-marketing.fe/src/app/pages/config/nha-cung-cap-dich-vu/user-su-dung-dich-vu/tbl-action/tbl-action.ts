...
import { IViewNhaMang } from '@/models/nha-mang.models';
import { IViewNhaCungCapDichVu, IViewUserNhaCungCapDto } from '@/models/nha-cung-cap-dich-vu.models';
...
export class TblAction extends BaseComponent {
    ...
    @Input() row: IViewUserNhaCungCapDto = {};
